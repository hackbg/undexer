...
export function query_query_protocol_parameters(a: number): number;
export function query_last_proposal_id(a: number): number;
export function query_query_proposals(a: number): number;
export function query_query_proposal(a: number, b: number): number;
...
export function query_query_voters_power_by_proposal_id(a: number, b: number): number;
export function query_get_address_from_u8(a: number, b: number, c: number): number;
export function initThreadPool(a: number): number;
export function __wbindgen_malloc(a: number, b: number): number;
export function __wbindgen_realloc(a: number, b: number, c: number, d: number): number;
export const __wbindgen_export_2: WebAssembly.Table;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4768f32c0d9ebe6d(a: number, b: number, c: number, d: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h5c8ab226d2077f6c(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h8031f6e368525066(a: number, b: number, c: number): void;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__hcd305ba137ae07b0(a: number, b: number, c: number, d: number): void;
